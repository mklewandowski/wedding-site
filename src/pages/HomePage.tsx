...
export default function HomePage() {
  return (
    <Box sx={{ textAlign: 'center' }}>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 1 }}>
        Service: Newport State Park Beach<br/><a href="https://www.google.com/maps/search/?api=1&query=Newport+State+Park+Beach+Ellison+Bay+WI+54210" target="_blank">407-381 Newport Park Rd, Ellison Bay, WI 54210</a>
      </Typography>
